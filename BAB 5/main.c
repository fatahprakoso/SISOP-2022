...
main()
{
  ...
  // TurnAround Time b= burst time, TotWT= Total Waiting Time, TotTA=
  // Total TurnAround time name= nama proses, AvWT= Average Waiting Time,
  // AvTA= Average TurnAround time
